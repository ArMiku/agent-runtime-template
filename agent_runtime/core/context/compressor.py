...
class ContextCompressor(Protocol):
    ...
    def should_compress(self, messages: list[Message], current_tokens: int, max_tokens: int) -> bool:
...
class LLMSummaryCompressor:
    ...
    async def __call__(self, messages: list[Message]) -> list[Message]:
        ...
        message_rounds = [[seg for seg in rnd if isinstance(seg, Message)] for rnd in rounds]

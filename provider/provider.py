...
from agent_runtime.core.message import ContentPart, Message, is_checkpoint_message
from agent_runtime.core.tool import ToolSet
from agent_runtime.foundation.paths import get_project_dir
from agent_runtime.media.resolver import default_media_resolver
...
from agent_runtime.provider.register import provider_cls_map
...
class AbstractProvider(abc.ABC):
    ...
    def __init__(self, provider_config: dict) -> None:
        ...
        # Injectable media-resolution seam (design.md §6.1). Defaults to the full
        # DefaultMediaResolver; consumers override per-instance to customise.
        self.media_resolver = default_media_resolver
...
class EmbeddingProvider(AbstractProvider):
    ...
    async def test(self) -> None:
        await self.get_embedding("agent_runtime")
